...
public class MailConfig {
	...
	@Bean
	@Profile("!dev")
	public MailSender mailSenderSmtp(){
		MailSenderSmtp sender = new MailSenderSmtp();
		
		sender.setJavaMailSender(getJavaMailSender());
		return sender;
	...
	private JavaMailSender getJavaMailSender() {
		...
		senderImpl.setSession(getMailSession());
